...
namespace AGA.Business
{
    ...
    public class TraiterAttestation : ITraiterAttestation
    {
        ...
        //TODO: Remplacer les DocX par les FileStream [Le wcf l'impose]
        ...
        private DocX getTemplate(String attestationCode)
        {
            ...
            Data.TypeAttestation typeAttestation = context.TypeAttestationSet.FirstOrDefault(type => type.Code == attestationCode);
            context.Dispose();
